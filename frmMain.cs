...
namespace BusylightTester
{
...

    {
        ...
        // Rot blinken, mit Sound
        internal void btnRedBlinkingWithSound_Click(object sender, EventArgs e)
        {
        ...
        // Gelb blinken, mit Sound
        internal void btnYellowBlinkingWithSound_Click(object sender, EventArgs e)
        {

            Busylight.BusylightVolume vol = (Busylight.BusylightVolume)tbVolume.Value;
            busylight.Alert(Busylight.BusylightColor.Yellow, Busylight.BusylightSoundClip.KuandoTrain, vol);

        }
        // Gelb blinken, kein Sound
        internal void btnYellowBlinkindWithoutSound_Click(object sender, EventArgs e)
        {

            // Statt "vol", wird der Wert 0 zugewiesen (Mute)
            Busylight.BusylightVolume vol = (Busylight.BusylightVolume)tbVolume.Value;
            busylight.Alert(Busylight.BusylightColor.Yellow, Busylight.BusylightSoundClip.KuandoTrain, 0);

        }

        // Rot blinken, kein Sound
        internal void btnRedBlinkingWithoutSound_Click(object sender, EventArgs e)
        {

            // Statt "vol", wird der Wert 0 zugewiesen (Mute)
            Busylight.BusylightVolume vol = (Busylight.BusylightVolume)tbVolume.Value;
            busylight.Alert(Busylight.BusylightColor.Red, Busylight.BusylightSoundClip.KuandoTrain, 0);

        }

        // Blau blinken, kein Sound
        internal void btnBlueBlinkingWithoutSound_Click(object sender, EventArgs e)
        {

            // Statt "vol", wird der Wert 0 zugewiesen (Mute)
            Busylight.BusylightVolume vol = (Busylight.BusylightVolume)tbVolume.Value;
            busylight.Alert(Busylight.BusylightColor.Blue, Busylight.BusylightSoundClip.KuandoTrain, 0);
        ...
        {
            busylight.Light(Busylight.BusylightColor.Blue);
        }
